...
export const BRIDGE_DEVICES: Message<Device[]> = {
    payload: [
        ...
        // Sleepy device (fast wake ~5s) - responds before frontend's 10s timeout
        {
            date_code: "20250101",
            definition: {
                description: "Sleepy test device (fast wake) - battery device with quick wakeup",
                exposes: [
                    {
                        access: 1,
                        category: "diagnostic",
                    ...
                    },
                    {
                        ...
                        features: [
                            ...
                            { access: 7, label: "Enabled", name: "enabled", property: "enabled", type: "binary", value_off: false, value_on: true },
                        ],
                    },
                    {
                        access: 7,
            ...
            friendly_name: "test/sleepy-device-fast",
            ieee_address: "0xtest00sleepy002",
            interview_completed: true,
            interview_state: "SUCCESSFUL",
            interviewing: false,
            manufacturer: "Test Manufacturer",
            model_id: "TEST-SLEEPY-002",
            network_address: 99997,
            power_source: "Battery",
            software_build_id: "1.0.0",
            supported: true,
            type: "EndDevice",
        },
        // Sleepy device (slow wake ~30s) - responds after frontend's 10s timeout, tests "queued" UX
        {
            date_code: "20250101",
            definition: {
                description: "Sleepy test device (slow wake) - battery device that queues commands",
                exposes: [
                    {
                        access: 1,
                        category: "diagnostic",
            ...
            friendly_name: "test/sleepy-device-slow",
