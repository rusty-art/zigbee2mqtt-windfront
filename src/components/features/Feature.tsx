...
export default function Feature({
    ...
    const isSleepy = device.power_source === "Battery";
    const wrapperParams = { feature, onRead, deviceValue, deviceStateVersion, parentFeatures, endpointSpecific, sourceIdx, isSleepy };
